  ...
  <div class="subcategory-management">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
      <div>
        ...
        <p class="text-sm text-gray-400 mt-1">{{ subcategories.length }} subkategori ditemukan</p>
      </div>
      <button 
        @click="openAddModal"
        ...
        <table class="w-full text-left border-collapse min-w-[800px]">
          <thead class="bg-gray-50 text-gray-500 text-xs uppercase tracking-wider">
            <tr>
              ...
              <th class="px-4 py-3 font-semibold">Nama Subkategori</th>
              <th class="px-4 py-3 font-semibold">Kategori Induk</th>
              <th class="px-4 py-3 font-semibold text-right whitespace-nowrap sticky right-0 bg-gray-50">Aksi</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-100 text-sm">
            <tr v-for="(sub, index) in subcategories" :key="sub.id" class="hover:bg-blue-50/30 transition-colors">
              ...
              <td class="px-4 py-3 font-semibold text-gray-800 whitespace-nowrap">{{ sub.name }}</td>
            ...
            <tr v-if="subcategories.length === 0">
              <td colspan="5" class="px-6 py-16 text-center">
                ...
                <p class="text-gray-400 font-medium">Belum ada subkategori</p>
                <p class="text-gray-300 text-sm mt-1">Klik "Tambah Subkategori" untuk membuat.</p>
              </td>
            </tr>
          </tbody>
        </table>
    ...
    <div v-if="isModalOpen" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div class="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
        ...
        <div class="p-6 space-y-4">
          ...
          <!-- 🖼️ Upload Gambar -->
          <div class="space-y-2">
            <label class="text-sm font-semibold text-gray-600">Gambar (JPG/PNG/WebP, maks 5MB)</label>
